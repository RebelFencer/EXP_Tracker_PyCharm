...
function insertNewRecord(data){
    ...
    var cell1 = newRow.insertCell(0);
        cell1.innerHTML = data.Onyx;
    var cell2 = newRow.insertCell(1);
        cell2.innerHTML = data.Gunther;
    var cell3 = newRow.insertCell(2);
        cell3.innerHTML = data.Andrasta;
    var cell4 = newRow.insertCell(3);
        cell4.innerHTML = data.Varren;
    var cell5 = newRow.insertCell(4);
        cell5.innerHTML = data.Phelles;
    var cell6 = newRow.insertCell(5);
        cell6.innerHTML = data.Zhuo;
    var cell7 = newRow.insertCell(6);
        cell7.innerHTML = data.Salvador;
    var cell8 = newRow.insertCell(7);
        cell8.innerHTML = data.Cadfael;
